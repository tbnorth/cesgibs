...
(function() {
  var css, gibs_layers, last_date, last_date_change_time, map_time, resolutions, template, viewer;
  ...
  this.init = function(cesium_viewer) {
    var arr, layer, _i, _len;
